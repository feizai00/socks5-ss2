...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法:")
        print("  生成SS链接: python3 fix_ss_link_corrected.py generate <password> <server_ip> <port> [node_name]")
        print("  测试SS链接: python3 fix_ss_link_corrected.py test <ss_link>")
        sys.exit(1)
